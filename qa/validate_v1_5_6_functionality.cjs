...
const SCREENSHOT = path.join(ROOT, 'screenshots', 'V1_5_6_602首页_桌面.png');
const MOBILE_SCREENSHOT = path.join(ROOT, 'screenshots', 'V1_5_6_602首页_手机.png');
...
async function main() {
  ...
  console.log('V1.5.6 Aurora Pro functionality browser QA: PASS');
}
