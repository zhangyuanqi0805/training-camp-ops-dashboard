...
const SCREENSHOT = path.join(ROOT, 'screenshots', 'V1_5_3_602整期总览_桌面.png');
const MOBILE_SCREENSHOT = path.join(ROOT, 'screenshots', 'V1_5_3_602整期总览_手机.png');
...
async function main() {
  ...
  console.log('V1.5.3 trend-funnel browser QA: PASS');
}
